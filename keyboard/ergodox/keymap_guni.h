static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	FN25 ,  Q,    W,   E,   R,   T,   HOME,
        ...
        // right hand
             ...
             END  , Y,   U,   I,    O,   P,FN28,
                   H,   J,   K,    L,SCLN,FN30,
             PGDN, N,   M,  COMM,DOT,SLSH,FN29,
                     RALT,  DOWN,UP ,NO  ,RGUI,
        NO  , NO,
        NO  ,
        FN29,ENT ,SPC 
    ),
    ...
    KEYMAP(  // layer 1 : function and symbol keys
        ...
        TRNS,FN18,FN2 ,LBRC,RBRC,FN3 ,TRNS,
        ...
        // right hand
             ...
             TRNS,FN10,FN11,FN12,EQL,FN13, TRNS,
    ...
    KEYMAP(  // layer 2: navigation 
        ...
        // right hand
             ...
             TRNS ,TRNS,  HOME,  TRNS,  TRNS, END ,TRNS,
